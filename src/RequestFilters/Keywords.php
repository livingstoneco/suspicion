...
class Keywords
{
	...
	{
		return ['wordpress','woocommerce','joomla','prestashop','ecommerce store','opencart','magento','bobinternetmarketing','business contacts','porn','capterra','dbms','whatsapp','search engine optimization','search results','google search','guest post','social media marketing','website traffic','no-reply','noreply','seo', 'smm', 'gay', 'homo', 'homosexual', 'sexual', 'dating', 'romance', 'babes', 'meet singles', 'earn income', 'earn money', 'freetopfast.com', 'xxx', 'email marketing', 'social media marketing', 'marketing solutions', 'blogger', 'article placement', 'service expiration', 'spam', 'medicine', 'human growth hormone', 'life insurance', 'lose weight', 'medicine', 'no medical exams', 'online pharmacy', 'removes wrinkles', 'reverses aging', 'stop snoring', 'valium', 'viagra', 'vicodin', 'weight loss', 'xanax', 'casino', 'paid members','lead generation'];
	}
